	...
	public static void main(String[] args) {
		...
		while(opcio!=5){
			...
			case 1:
				...
				System.out.print("Determina una direcció (1=Horitzontal/ 2=Vertical/ 3=Diagonal): ");
				direccio= sc.nextInt();	
	...
	private static void insertarParaula(String paraula,char[][] matriu, int[] posicio, int direccio) {
		...
		if(direccio==1){
			...
			if(coincideix){
				...
				System.out.println("S'ha insertart la paraula '"+ paraula +"' a la posició ("+ posicio[0]+ ","+posicio[1]+") en horitzontal");
			}else{
		...
		//Paraula en vertical	
			...
			if(coincideix){
				...
				System.out.println("S'ha insertart la paraula '"+ paraula +"' a la posició ("+ posicio[0]+ ","+posicio[1]+") en vertical");
			}else{
				System.out.println("La paraula es creua amb una altre pero la lletra no coincideix.");
			}
		}
			...
			if(coincideix){
				...
				System.out.println("S'ha insertart la paraula '"+ paraula +"' a la posició ("+ posicio[0]+ ","+posicio[1]+") en diagonal");
			}else{
				System.out.println("La paraula es creua amb una altre pero la lletra no coincideix.");
			}
		}
