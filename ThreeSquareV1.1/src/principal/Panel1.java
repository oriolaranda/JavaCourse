...
public class Panel1 extends JPanel implements MouseListener {
	...
	public void initComponents(){
		...
		comentari.setBounds(100, 280, 300, 40);		
		add (comentari);
	...
	public void mouseClicked(MouseEvent e) {
		...
		if(e.getComponent().isEnabled()){
			 ...
			 if (alg.torn_enter % 2 == 0){
				 ...
				 comentari.setText("Torn del jugador 1.......Tira al quadrat" + (alg.casella+1));
				 ...
				 comentari.setText("Torn del jugador 2..........Tira al quadrat" + (alg.casella+1));
