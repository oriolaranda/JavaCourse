...
public class Algorismes {
	 ...
	 * si hauries de tirar en un quadrat que esta en 3 en ralla
	 * poder tirar a un quadrat qualsevol
	 * */
	public void enableQuadrat(){
		...
		if (taulell [casella] ==1 || taulell[casella]==3){
			enableAll();
			comprovacioRequadre();
		}
		}
	...
	//////////////////////////////////////////////////////////////
		// comprovar quins requadres estan en 3 en ralla i per tant no si pot anar
		
	public void comprovacioRequadre(){
