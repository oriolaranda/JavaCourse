...
public class DF implements ActionListener, KeyListener{
...
public JPanel Descomposicio(JPanel panelDF){
	panelDF.setBorder(new EmptyBorder(5, 5, 5, 5));
	panelDF.setLayout(new BorderLayout(0, 0));
	panelDF.setVisible(true);
	panelDF.setBorder(new EtchedBorder(EtchedBorder.RAISED, null, null));
	panelDF.setLayout(null);
	
	label(panelDF, desc);
	numero(panelDF, numero);
	grafic(panelDF, grafic, barra);
	formula(panelDF, formula, barra2);
    descomposar(panelDF, Descomposar, numero, grafic, formula);
    reset(panelDF, Reset, numero, grafic, formula);
    return panelDF;
}
